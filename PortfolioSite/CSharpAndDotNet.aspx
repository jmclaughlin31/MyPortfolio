<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CSharpAndDotNet.aspx.cs" Inherits="PortfolioSite.CSharpAndDotNet" %>
					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								...
								<li class="current"><a href="CSharpandDotNet.aspx">C# | .Net Experience</a></li>
